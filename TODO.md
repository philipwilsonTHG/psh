...
- ~~**Command Substitution in Arithmetic**~~: ✅ FIXED in v0.28.9 - Command substitutions are now pre-expanded before arithmetic evaluation. Expressions like `$(($(get_number) * 2))` work correctly by expanding the command substitution first, then evaluating the arithmetic.
