...
class Shell:
    def __init__(self, args=None, script_name=None):
        ...
        self.builtins = self.builtin_commands.get_builtin_map()
        
        # Backward compatibility - delegate to builtin_commands
        self._builtin_exit = self.builtin_commands.exit
        self._builtin_cd = self.builtin_commands.cd
        self._builtin_export = self.builtin_commands.export
        self._builtin_pwd = self.builtin_commands.pwd
        self._builtin_echo = self.builtin_commands.echo
        self._builtin_env = self.builtin_commands.env
        self._builtin_unset = self.builtin_commands.unset
        self._builtin_source = self.builtin_commands.source
        self._builtin_history = self.builtin_commands.history
        self._builtin_set = self.builtin_commands.set
        self._builtin_version = self.builtin_commands.version
        self._builtin_alias = self.builtin_commands.alias
        self._builtin_unalias = self.builtin_commands.unalias
        self._builtin_declare = self.builtin_commands.declare
        self._builtin_return = self.builtin_commands.return_builtin
        self._builtin_jobs = self.builtin_commands.jobs
        self._builtin_fg = self.builtin_commands.fg
        self._builtin_test = self.builtin_commands.test
        self._builtin_bg = self.builtin_commands.bg
        self._builtin_true = self.builtin_commands.true
        self._builtin_false = self.builtin_commands.false
        # History setup
        self.history = []
