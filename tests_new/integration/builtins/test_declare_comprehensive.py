...
class TestDeclareSpecialCases:
    ...
    @pytest.mark.xfail(reason="Advanced declare features may not be fully implemented")
    ...
    @pytest.mark.xfail(reason="Global attribute may not be fully implemented")
...
class TestDeclareCompatibility:
    ...
    def test_declare_in_subshell(self, shell, capsys):
        ...
        var = shell.state.variables.get("SUBSHELL_VAR")
