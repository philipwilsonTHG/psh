...
class TestBashParameterExpansion(ConformanceTest):
    ...
    @pytest.mark.xfail(reason="Advanced parameter expansion may not be implemented")
    ...
    @pytest.mark.xfail(reason="Pattern substitution may not be implemented")
...
class TestBashArithmeticExpansion(ConformanceTest):
    ...
    @pytest.mark.xfail(reason="Variable assignment in arithmetic may not be implemented")
...
class TestBashJobControl(ConformanceTest):
    ...
    @pytest.mark.xfail(reason="Job control commands may not be fully implemented")
...
class TestBashHistory(ConformanceTest):
    ...
    @pytest.mark.xfail(reason="History commands may not be implemented")
